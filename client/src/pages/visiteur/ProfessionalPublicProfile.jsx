...
const s = {
  ...
  backBtn: {border: "1px solid #182f47ff",background: "#fff",color: "#334155",borderRadius: 8,padding: "8px 12px",cursor: "pointer",display: "inline-flex",alignItems: "center",gap: 6,marginBottom: 12,fontWeight: 600,},
  ...
  ratingBadge: { display: 'flex', alignItems: 'center', gap: '4px', background: '#fffbeb', color: '#b45309', padding: '4px 8px', borderRadius: '12px', fontSize: '14px', fontWeight: '700', border: '1px solid #fde68a' },
  ratingCount: { color: '#b45309',fontSize: '12px', fontWeight: '500' },
  ...
  btnReport: { width: '35px', height: '35px', display: 'flex', alignItems: 'center', justifyContent: 'center', background: '#fff', color: '#ef4444', border: '1px solid #e2e8f0', borderRadius: '12px', cursor: 'pointer', transition: '0.2s ease' },
  ...
  reviewSubmitBtn: { background: '#253141ff', color: 'white', border: 'none', padding: '12px 30px', borderRadius: '12px', fontWeight: '700', cursor: 'pointer' },
