    ...
    <div style={styles.container}>
      <div style={styles.header}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', width: '100%' }}>
          <div>
            <h1 style={styles.title}>Facturation</h1>
            <p style={styles.subtitle}>
              {filterOrderId || filterReservationId 
                ...
                : "Gérez les factures émises pour vos prestations."
              }
            </p>
          </div>
          {(filterOrderId || filterReservationId) && (
      ...
      <div style={styles.statsRow}>
        <div style={styles.statCard}>
          ...
          <div>
            <div style={styles.statLabel}>Chiffre d'Affaires Total</div>
          ...
          <table style={styles.table}>
            <thead>
              <tr style={styles.tableHeader}>
                <th style={styles.th}>Facture N°</th>
