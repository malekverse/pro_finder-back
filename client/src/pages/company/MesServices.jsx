    ...
    <div style={{ padding: "40px", backgroundColor: "#f8fafc", minHeight: "100vh" }}>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '2.5rem' }}>
        <div>
          ...
          <p style={{ color: "#64748b", marginTop: "5px" }}>Gérez les prestations de votre entreprise.</p>
        </div>
        <button 
      ...
      {isLoading ? (
        ...
        <div style={{ textAlign: 'center', padding: '100px', backgroundColor: 'white', borderRadius: '24px', border: '2px dashed #e2e8f0' }}>
          ...
          <p style={{ color: '#94a3b8' }}>{searchQuery ? "Aucun résultat pour votre recherche." : "Commencez par ajouter votre premier service."}</p>
        </div>
      ) : (
        ...
        <div style={{ position: 'fixed', top: 0, left: 0, right: 0, bottom: 0, backgroundColor: 'rgba(0,0,0,0.5)', display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 1000, padding: '20px' }}>
          <div style={{ backgroundColor: 'white', borderRadius: '24px', width: '100%', maxWidth: '600px', maxHeight: '90vh', overflowY: 'auto', padding: '32px', boxShadow: '0 20px 25px -5px rgba(0,0,0,0.1)' }}>
            ...
            <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                <label style={{ fontSize: '14px', fontWeight: '600', color: '#475569' }}>Images du service</label>
              ...
              <div style={{ display: 'flex', gap: '12px', marginTop: '12px' }}>
                ...
                >
                  {(isCreating || isUpdating) ? <Loader2 className="animate-spin" size={20} /> : (editMode ? "Mettre à jour" : "Enregistrer le service")}
                </button>
              </div>
            </form>
          </div>
