...
router.put("/updateprofile",verifyJWT,authorizeRoles("company", "admin"),upload.fields([
    { name: 'logo',  maxCount: 1 },{ name: 'cover', maxCount: 1 }]),companyController.updateCompanyProfile);
